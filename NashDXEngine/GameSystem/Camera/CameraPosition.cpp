...
void CameraPosition::SetPosition(float x, float y, float z)
{
	m_positionX = x;
	m_positionY = y;
	m_positionZ = z;
...
void CameraPosition::SetRotation(float x, float y, float z)
{
	m_rotationX = x;
	m_rotationY = y;
	m_rotationZ = z;
...
void CameraPosition::GetPosition(float& x, float& y, float& z)
{
	x = m_positionX;
	y = m_positionY;
	z = m_positionZ;
...
void CameraPosition::GetRotation(float& x, float& y, float& z)
{
	x = m_rotationX;
	y = m_rotationY;
	z = m_rotationZ;
...
void CameraPosition::MoveForward(bool keydown)
{
	float radians;
...
void CameraPosition::MoveBackward(bool keydown)
{
	float radians;
...
void CameraPosition::MoveUpward(bool keydown)
{
...
void CameraPosition::MoveDownward(bool keydown)
{
...
void CameraPosition::LookUpward(bool keydown)
{
...
void CameraPosition::LookDownward(bool keydown)
{
