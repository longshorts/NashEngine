...
bool UserInterface::Initialize(D3DManager* Direct3D, int screenHeight, int screenWidth)
{
	...
	result = m_Font1->Initialize(D3DManager::getInstance()->GetDevice(), D3DManager::getInstance()->GetDeviceContext(), "../Assets/Fonts/font01.txt",
		"../Assets/Fonts/font01.tga", 32.0f, 3);
	if (!result)
	{
		return false;
	}
...
bool UserInterface::Render(D3DManager* Direct3D, ShaderManager* ShaderManager, XMMATRIX worldMatrix, XMMATRIX viewMatrix,
